...
int main(int argc, char* argv[])
{
	...
	{
		printf("formal  : task -address 220.248.44.218 -heartbeat 21000 -interval 30(second) -port 21010 -redis upload 6379 -redis sending 6380 -database coglink2/coglink2013@CLORCL -log path ../log/task.log \n");
		printf("example : task -a 220.248.44.218 -h 21000 -i 30 -p 21010 -r 6379 -s 6380 -d coglink2/coglink2013@CLORCL -l ../log/task.log \n");
		return 0;
	}
