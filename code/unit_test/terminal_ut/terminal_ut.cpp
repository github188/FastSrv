...
int main(int argc, char* argv[])
{
	...
	{
		printf("formal  : terminal_ut -c(peer address) 192.168.1.65 -port 21010 -log path ../log/terminal_ut.log \n");
		printf("example (conn balance) : terminal_ut -c 192.168.1.65 -p 21001 -l ../log/terminal_ut.log \n");
		printf("example (conn task)    : terminal_ut -c 192.168.1.65 -p 21010 -l ../log/terminal_ut.log \n");
		return 0;
	}
