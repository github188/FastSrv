...
TLV_HANDLE_RTN HttpInterface::notifyJava(const string& java_addr, const string& dev_id, const string& type, const string& value, const string& other)
{
	//查询
	string request;
	string result;
	...
	request = "http://";
	request += java_addr + "/dplus/corp/linkman/sendMsg.jspa?deviceId=";
